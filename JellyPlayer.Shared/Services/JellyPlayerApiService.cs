...
public class JellyPlayerApiService : IJellyPlayerApiService, IDisposable
{
    ...
    public JellyPlayerApiService(JellyfinSdkSettings sdkClientSettings, JellyfinApiClient jellyfinApiClient)
    {
